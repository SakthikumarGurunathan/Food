...
export default function MainCarousal(props){
    ...
    const scrollLeft = () => {
        if (scrollContainerRef.current) {
          scrollContainerRef.current.scrollBy({ left: -425, behavior: 'smooth' });
        }
      };
